...
describe('admin auth', () => {
  ...
  it('should grant dashboard access when user has admin role', async () => {
    mockGetCurrentUser.mockResolvedValue(
      createFakeAuthUser({ profile: { role: ['Admin'] } }),
    )
  ...
  it('should redirect to sign-in when user does not have admin role', async () => {
