...
describe('useNotificationStore', () => {
  ...
  it('should load notifications for admin user from the API', async () => {
  ...
  it('should prepend realtime notification and increment unread count', () => {
    const store = useNotificationStore()

    store.prependFromHub({
      id: 'notification-002',
      eventType: 'admin.new_seller',
      payload: JSON.stringify({ sellerName: 'New Seller', storeName: 'New Store' }),
