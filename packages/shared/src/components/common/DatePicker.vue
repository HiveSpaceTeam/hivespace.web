...
const confirmSelection = () => {
  ...
  if (props.format === 'date-local') {
    const yyyy = tempSelectedDate.value.getFullYear()
    const MM = formatTwoDigits(tempSelectedDate.value.getMonth() + 1)
    const dd = formatTwoDigits(tempSelectedDate.value.getDate())
