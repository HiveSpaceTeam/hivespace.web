              ...
              <div>
                ...
                <div class="mt-5">
                  <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                    ...
                    <router-link to="/demo/signup" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Sign
                      Up</router-link>
                  </p>
                </div>
              </div>
        ...
        <div class="relative items-center hidden w-full h-full lg:w-1/2 bg-brand-950 dark:bg-white/5 lg:grid">
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              <router-link to="/demo" class="block mb-4">
...
import { ref } from 'vue'
import { FullScreenLayout, CommonGridShape, BackArrowIcon, GoogleIcon, XBrandIcon, EyeIcon, EyeOffIcon, CheckIcon } from '@hivespace/shared'
const email = ref('')
const password = ref('')
